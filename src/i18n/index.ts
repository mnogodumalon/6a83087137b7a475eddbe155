...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    ...
    "apps": {
      "mitglieder": {
        "name": "Mitglieder",
        "app_id": "6a830842d546c8fd548dbdb8",
        "fields": {
          "vorname": "Vorname",
          "nachname": "Nachname",
      ...
      "sitzungen": {
        "name": "Sitzungen",
        "app_id": "6a8308470e2a00ba472be888",
        "fields": {
          ...
          "mitglieder": "Eingeladene Mitglieder",
          "einlade_link": "Öffentlicher Einlade-Link",
          "einladung_versendet": "Einladung per E-Mail versendet",
          "sitzungsstatus": "Status der Sitzung"
        },
        "lookups": {
          "sitzungsstatus": {
            "geplant": "Geplant",
      ...
      "anmeldungen": {
        "name": "Anmeldungen",
        "app_id": "6a830848df6bc1d8327d7346",
        "fields": {
          "sitzung": "Sitzung",
          "vorname": "Vorname",
          "nachname": "Nachname",
      ...
      "protokolle": {
        "name": "Protokolle",
        "app_id": "6a830848410a45fc7acca208",
        "fields": {
          "protokollstatus": "Status",
          "titel": "Titel des Protokolls",
          "sitzung": "Zugehörige Sitzung",
          "erstellungsdatum": "Erstellungsdatum",
          "protokollfuehrer_vorname": "Vorname Protokollführer",
          "protokollfuehrer_nachname": "Nachname Protokollführer",
          "inhalt": "Protokollinhalt",
      ...
      "themen_feedback": {
        "name": "Themen & Feedback",
        "app_id": "6a830849735ddb18565dec96",
        "fields": {
          "thementitel": "Titel des Themas",
          "sitzung": "Zugehörige Sitzung",
          "beschreibung": "Beschreibung des Themas",
          "verantwortlicher": "Verantwortliches Mitglied",
          "themenstatus": "Status des Themas",
      ...
      "notizen": {
        "name": "Notizen",
        "app_id": "6a83084a4ec6d662da521bce",
        "fields": {
          "notiz_titel": "Titel der Notiz",
          "notiz_text": "Notiztext",
          "ersteller_vorname": "Vorname Ersteller",
          "ersteller_nachname": "Nachname Ersteller",
          "notiz_datum": "Datum der Notiz",
          "notiz_typ": "Typ der Zuordnung",
          "sitzung": "Zugehörige Sitzung",
          "protokoll": "Zugehöriges Protokoll",
          "mitglied": "Zugehöriges Mitglied"
        },
        "lookups": {
          "notiz_typ": {
            "sitzung": "Sitzung",
    ...
    "apps": {
      ...
      "sitzungen": {
        ...
        "fields": {
          ...
          "tagesordnung": "Agenda",
          "mitglieder": "Invited Members",
          "einlade_link": "Public Invite Link",
          "einladung_versendet": "Invitation Sent by Email",
          "sitzungsstatus": "Session Status"
        },
        "lookups": {
          "sitzungsstatus": {
            "geplant": "Scheduled",
      ...
      "protokolle": {
        ...
        "fields": {
          "protokollstatus": "Status",
          "titel": "Minutes Title",
          "sitzung": "Associated Session",
          "erstellungsdatum": "Creation Date",
          "protokollfuehrer_vorname": "Minutes Taker First Name",
          "protokollfuehrer_nachname": "Minutes Taker Last Name",
          "inhalt": "Minutes Content",
      ...
      "themen_feedback": {
        ...
        "app_id": "6a830849735ddb18565dec96",
        "fields": {
          "thementitel": "Topic Title",
          "sitzung": "Associated Session",
          "beschreibung": "Topic Description",
          "verantwortlicher": "Responsible Member",
          "themenstatus": "Topic Status",
          "feedback_text": "Feedback",
          "bewertung": "Rating"
        },
        "lookups": {
      ...
      "notizen": {
        ...
        "fields": {
          ...
          "notiz_text": "Note Text",
          "ersteller_vorname": "Creator First Name",
          "ersteller_nachname": "Creator Last Name",
          "notiz_datum": "Note Date",
          "notiz_typ": "Assignment Type",
          "sitzung": "Associated Session",
          "protokoll": "Associated Minutes",
          "mitglied": "Associated Member"
        },
        "lookups": {
          "notiz_typ": {
            "sitzung": "Session",
