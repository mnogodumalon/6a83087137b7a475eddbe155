...
export function MitgliederDialog({ open, onClose, onSubmit, defaultValues, recordId, enablePhotoScan = true, enablePhotoLocation = true }: MitgliederDialogProps) {
  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'funktion': (
      <div key="funktion" className="space-y-1.5">
        ...
        <Input
          id="funktion"
          placeholder="z. B. Vorsitzender, Kassenwart"
  ...
  const FIELD_LABELS: Record<string, string> = {"vorname": "Vorname", "nachname": "Nachname", "email": "E-Mail-Adresse", "telefon": "Telefonnummer", "funktion": "Funktion im Gremium", "abteilung": "Abteilung", "status": "Status"};
