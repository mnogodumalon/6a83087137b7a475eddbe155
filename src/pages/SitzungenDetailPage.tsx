  ...
  return (
    ...
    >
      ...
      <RecordSection title={t('details')} cols={2}>
        ...
        <RecordField label={fieldLabel('sitzungen', 'mitglieder')} value={Array.isArray(record.fields.mitglieder) ? record.fields.mitglieder.map((u: unknown) => getMitgliederDisplayName(u)).join(', ') : null} format="text" />
