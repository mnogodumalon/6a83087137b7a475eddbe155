...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['titel', 'datum', 'ort', 'sitzungsstatus', 'mitglieder', 'einladung_versendet', 'beschreibung', 'tagesordnung', 'einlade_link'],
  defaults: {
    'datum': { kind: 'today', withTime: true },
    'sitzungsstatus': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
  },
  computed: {},
};
