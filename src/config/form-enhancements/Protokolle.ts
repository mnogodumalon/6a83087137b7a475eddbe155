...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["protokollstatus", "titel", "sitzung", "erstellungsdatum", {"row": ["protokollfuehrer_vorname", "protokollfuehrer_nachname"]}, "inhalt", "beschluesse"],
  defaults: {
    'erstellungsdatum': { kind: 'today' },
    'protokollstatus': { kind: 'lookup', key: 'entwurf', label: 'Entwurf' },
  },
  computed: {},
};
