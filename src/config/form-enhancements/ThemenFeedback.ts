// Auto-generated. Per-entity form-enhancements config for "Themen & Feedback".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['thementitel', 'sitzung', 'verantwortlicher', 'themenstatus', 'beschreibung', 'feedback_text', 'bewertung'],
  defaults: {
    'themenstatus': { kind: 'lookup', key: 'offen', label: 'Offen' },
  },
  computed: {},
};
